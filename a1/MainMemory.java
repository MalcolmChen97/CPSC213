...
public class MainMemory extends AbstractMainMemory {
  ...
  @Override public int bytesToInteger (byte byteAtAddrPlus0, byte byteAtAddrPlus1, byte byteAtAddrPlus2, byte byteAtAddrPlus3) {
      int a = (byteAtAddrPlus0 & 0xff) << 24;
      int b = (byteAtAddrPlus1 & 0xff) << 16;
      int c = (byteAtAddrPlus2 & 0xff) << 8;
      int d = (byteAtAddrPlus3 & 0xff);
  ...
  @Override public byte[] integerToBytes (int i) {
      byte[] bytesha=new byte[4];
      bytesha[0]= Integer.valueOf(i>>24).byteValue();
      bytesha[1]= Integer.valueOf(i>>16).byteValue();
      bytesha[2]= Integer.valueOf(i>>8).byteValue();
      bytesha[3]= Integer.valueOf(i).byteValue();
      return bytesha;
  }
  ...
  @Override protected void set (int address, byte[] value) throws InvalidAddressException {
        if(address<0||address>length()-value.length){
            throw new InvalidAddressException();
        }
